...
| Concepto | Monto |
|----------|-------|
| Precio base (4 meses, equipo 4 + RAG) | Bs. 28,000 |
| IVA 13% | Bs. 3,640 |
| **TOTAL IVA incluido** | **Bs. 31,640** |
| Monto mensual promedio | Bs. 7,000 base |

Incluye diseño, desarrollo React/AntD/Vite, backend RAG, vector DB, Vercel/Railway config, docs, capacitación y garantía 60 días. **NO incluye** hosting/dominio/planes premium LLM (OpenAI, Pinecone, etc.) más allá de tiers gratuitos; esos corren por cuenta EL BUFFET (EQUIPO asesora minimizando costo).
...
#### 6.4. Forma de pago — 5 hitos (alineado a sprints)

| Hito | Plazo | % | Bs. IVA incl. | Entregables validados |
|------|-------|---|---------------|-----------------------|
| **H1** Firma + Plan/Mockups aprobados | Semana 2 | 20% | 6,328 | E1+E2 |
| **H2** Ingesta inteligente completada | Semana 6 | 15% | 4,746 | E3+E4 |
| **H3** RAG + Audiencias completadas | Semana 10 | 25% | 7,910 | E5+E6 |
| **H4** QA staging superada | Semana 14 | 15% | 4,746 | E7+E8+E9 |
| **H5** Prod + docs + capacitación (inicio garantía) | Semana 16 | 25% | 7,910 | E10+E11+E12 |
