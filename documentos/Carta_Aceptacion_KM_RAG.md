...
#### 3.3. Forma de pago aceptada — 5 hitos (Bs. 31,640 IVA incl.)

Aceptamos **Bs. 31,640** total IVA incluido (Bs. 28,000 base + Bs. 3,640 IVA 13%):

| Hito | Plazo | % | Bs. IVA incl. | Entregables validados |
|------|-------|---|---------------|-----------------------|
| **H1** | Semana 2 | 20% | 6,328 | **E1** Plan/cronograma + **E2** Figma + arquitectura + decisión BD |
| **H2** | Semana 6 | 15% | 4,746 | **E3** Auth+Casos + **E4** Ingesta+clasificación+dedup |
| **H3** | Semana 10 | 25% | 7,910 | **E5** RAG+chat + **E6** Alertas+audiencias+PDF |
| **H4** | Semana 14 | 15% | 4,746 | **E7** Versiones+compartición+auditoría + **E8** pulido + **E9** QA staging superada |
| **H5** | Semana 16 (cierre + inicio garantía) | 25% | 7,910 | **E10** Prod Vercel/Railway + **E11** docs + **E12** capacitación |
