...
|--------|----------|--------------|
| **OE1** | **Analizar** los requerimientos de recuperación de información jurídica y **diseñar** un motor de búsqueda semántica con RAG tolerante a errores ortográficos y sinónimos jurídicos bolivianos | RF-12, RF-13, RF-14 |
| **OE2** | **Diseñar** un módulo de clasificación y organización automática por caso y tipo documental sin etiquetado manual | RF-05, RF-06, RF-08, RF-09 |
| **OE3** | **Desarrollar** un sistema de alertas proactivas e inteligentes de vencimientos (órdenes de protección) y audiencias (48h/24h/2h) | RF-15, RF-16, RF-17, RF-21, RF-22 |
| **OE4** | **Implementar** una plataforma web segura (AES-256, TLS 1.3, RBAC), móvil y con control de acceso por roles y a nivel de chunk | RF-01, RF-02, RF-03, RF-04, RF-24, RF-25 |
| **OE5** | **Implementar** un mecanismo de control de versiones, desduplicación (>85% similitud) y auditoría inmutable | RF-10, RF-11, RF-29 |
| **OE6** | **Validar** el sistema de compartición segura con enlaces temporales JWT, watermark y revocación inmediata | RF-18, RF-19, RF-20 |
...
|------|---|-----------------------|--------|---------------------|
| Firma + Plan aprobado | 20% | 3,390 | Sprint 1 | E1 + E2 (plan + mockups) |
| Sprint 3 completado (ingesta + clasificación) | 15% | 2,542.50 | Sprint 3 | E3 + E4 |
| Sprint 5 completado (RAG + audiencias) | 25% | 4,237.50 | Sprint 5 | E5 + E6 |
| QA staging superada | 15% | 2,542.50 | Sprint 7 | E7 + E8 + E9 |
| Despliegue prod. + documentación + capacitación | 25% | 4,237.50 | Sprint 8 | E10 + E11 + E12 |
